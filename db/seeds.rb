...
Listing.create(category: Category.find_by(name: "personal"), user: User.find_by(first_name: "Steven"), slogan: "The best 'fake' boyfriend you'll ever have", description: "I can help you wipe the disappointment off your parents faces when you bring me home", fee: 600)
Listing.create(category: Category.find_by(name: "personal"), user: User.find_by(first_name: "Jason"), slogan: "Need a wedding date? I'm your man!", description: "I have my own suit and can talk you up to anyone that'll listen", fee: 500)
Listing.create(category: Category.find_by(name: "personal"), user: User.find_by(first_name: "Katie"), slogan: "I eat everything", description: "Pay for my meal and I'll come with you to anything... nothing is to weird for me!", fee: 0)
Listing.create(category: Category.find_by(name: "professional"), user: User.find_by(first_name: "Gertrude"), slogan: "How can I help you?", description: "I have real life experience as a PA so I can be the best fake one", fee: 750)
